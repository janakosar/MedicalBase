...
var PatientDetailsComponent = /** @class */ (function (_super) {
    ...
    PatientDetailsComponent.prototype.subscribeOnUrlChanges = function () {
        var _this = this;
        this.subscription = this.route.url.subscribe(function (u) {
            _this.parseRoute(_this.route);
        });
    };
    ...
    PatientDetailsComponent.prototype.parseRoute = function (route) {
        var _this = this;
